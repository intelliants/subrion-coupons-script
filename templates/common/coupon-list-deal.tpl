<div class="ia-item ia-item--border {if $coupon.featured} ia-item--featured{/if}{if $coupon.sponsored} ia-item--sponsored{/if}" data-affiliate-link="{if $coupon.affiliate_link && 'http://' != $coupon.affiliate_link}{$coupon.affiliate_link}{elseif $coupon.shop_affiliate_link && 'http://' != $coupon.shop_affiliate_link}{$coupon.shop_affiliate_link}{/if}" id="coupon-list-{$coupon.id}">
