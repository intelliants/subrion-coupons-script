        ...
        <div class="ia-item-author__image">
            ...
            {else}
                <a href="{$smarty.const.IA_URL}shop/{$shop.title_alias}.html">
                    <img src="//api.webthumbnail.org?width=150&height=150&format=png&screen=1024&url={$shop.website}" alt="Generated by WebThumbnail.org" class="img-responsive center-block">
                </a>
            {/if}
        </div>

        <div class="ia-item-author__content">
            <h4 class="ia-item__title"><a href="{$smarty.const.IA_URL}shop/{$shop.title_alias}.html">{$shop.title|escape}</a></h4>
